...
func TestCollectLegacyPayloads_ValidPayload(t *testing.T) {
	...
	r.collectLegacyPayloads(&components, &diags, dynVal, "My Blueprint", testPayloadIdentifierNamespace)
...
func TestCollectLegacyPayloads_NoSettings(t *testing.T) {
	...
	r.collectLegacyPayloads(&components, &diags, dynVal, "Blueprint", testPayloadIdentifierNamespace)
...
func TestCollectLegacyPayloads_MixedTypeSettings(t *testing.T) {
	...
	r.collectLegacyPayloads(&components, &diags, dynVal, "Test", testPayloadIdentifierNamespace)
...
func TestCollectLegacyPayloads_EmptyList(t *testing.T) {
	...
	r.collectLegacyPayloads(&components, &diags, dynVal, "Empty Blueprint", testPayloadIdentifierNamespace)
...
func TestCollectLegacyPayloads_NullDynamic(t *testing.T) {
	...
	r.collectLegacyPayloads(&components, &diags, types.DynamicNull(), "Blueprint", testPayloadIdentifierNamespace)
