...
func TestEnumLiteralsComeFromTheSDK(t *testing.T) {
	got, err := enumguard.Check(enumguard.Params{
		Covered: enumguard.Union(
			pro.ComputerExtensionAttributesDataTypeValues(),
			pro.ComputerExtensionAttributesInputTypeValues(),
			pro.ComputerExtensionAttributesManageExistingDataValues(),
			pro.ComputerExtensionAttributesInventoryDisplayTypeValues(),
		),
	})
	if err != nil {
