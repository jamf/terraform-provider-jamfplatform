...
func TestResourceSDKMethods_MatchCRUDCalls(t *testing.T) {
	...
	// Matches both r.client.<Method>( and the toggleClient param client.<Method>(
	// — crud.go's poll-to-settle helpers take the SDK client as a `client`
	// argument, so the receiver is `client.` in both forms.
