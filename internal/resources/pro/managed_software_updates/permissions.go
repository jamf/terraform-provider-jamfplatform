...
// resourceSDKMethods lists the SDK methods the managed software update
...
var resourceSDKMethods = []string{
	"GetManagedSoftwareUpdateFeatureToggleV1",
	"UpdateManagedSoftwareUpdateFeatureToggleV1",
	"GetManagedSoftwareUpdateFeatureToggleStatusV1",
}

// resourcePrivileges is the rendered "Required Jamf permissions" Markdown
// section for the managed software update resource, appended to its
// MarkdownDescription.
