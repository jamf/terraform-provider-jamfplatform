...
// TestResourcePrivileges_Rendered is a guard that the privileges section
// actually rendered into the resource description (catches an empty/parse-
// skipped registry). The icon SDK methods carry no scoped privilege entries,
