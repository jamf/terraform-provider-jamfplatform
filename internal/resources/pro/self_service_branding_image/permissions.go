...
// resourceSDKMethods lists the SDK methods the Self Service branding image
...
var resourceSDKMethods = []string{
	"UploadBrandingImageV1",
	"DownloadBrandingImageV1",
}

// resourcePrivileges is the rendered "Required Jamf permissions" Markdown
// section for the Self Service branding image resource, appended to its
// MarkdownDescription.
