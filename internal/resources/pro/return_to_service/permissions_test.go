...
// ResolveReturnToServiceConfigurationV1ByName) that are not themselves
...
// ResolveReturnToServiceConfigurationV1ByName, an SDK resolver wrapper absent
// from the registry; registryKnownCalls filters it out so the assertion
// compares only privileged endpoints.
