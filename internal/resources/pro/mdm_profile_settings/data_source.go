...
func (d *MDMProfileSettingsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Read the current Jamf Pro device communication settings (Settings → Device communication → MDM profile settings). One record per tenant." + dataSourcePrivileges,
