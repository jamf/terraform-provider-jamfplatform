...
// resourceSDKMethods lists the SDK methods the device communication settings
...
var resourceSDKMethods = []string{
	"GetDeviceCommunicationSettingsV1",
	"UpdateDeviceCommunicationSettingsV1",
}

// resourcePrivileges is the rendered "Required Jamf permissions" Markdown
// section for the device communication settings resource, appended to its
// MarkdownDescription.
var resourcePrivileges = permissions.Section(pro.Privileges, resourceSDKMethods...)

// dataSourceSDKMethods lists the SDK methods the device communication settings
...
// section for the device communication settings data source, appended to its
// MarkdownDescription.
