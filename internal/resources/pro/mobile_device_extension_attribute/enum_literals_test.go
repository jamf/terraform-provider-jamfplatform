...
func TestEnumLiteralsComeFromTheSDK(t *testing.T) {
	got, err := enumguard.Check(enumguard.Params{
		Covered: enumguard.Union(
			pro.MobileDeviceExtensionAttributesDataTypeValues(),
			pro.MobileDeviceExtensionAttributesInputTypeValues(),
			pro.MobileDeviceExtensionAttributesInventoryDisplayTypeValues(),
		),
	})
	if err != nil {
