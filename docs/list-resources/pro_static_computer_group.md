...
page_title: "jamfplatform_pro_static_computer_group List Resource - terraform-provider-jamfplatform"
subcategory: ""
description: |-
  Finds Jamf Pro static computer groups using the same filter clauses as the jamfplatform_pro_static_computer_groups data source. Generated configurations leave assigned_computer_ids out, so membership stays as Jamf Pro holds it until you declare otherwise.
...
# jamfplatform_pro_static_computer_group (List Resource)
